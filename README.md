...
<ul>
    <li>Download <a href="repository.709-1.2.zip?file=path/<?=$row['repositoy.709-1.1.zip']?>">repository.709-1.2.zip</a></li>
    <li>Go to Kodi Add-Ons to open the Addon Browser, then select "Install from zip file"</li>
    <li>Navigate to where you saved repository.709-1.2.zip and select to install</li>
</ul>
